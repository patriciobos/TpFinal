...
//#include "ConfiguracionRed.h" //Por que la ethernetif tiene que ver la conf de red?
...
static void boardCONFIGURE_ENET_PINS (PINSEL_CFG_Type dummy);
...
static void boardCONFIGURE_ENET_PINS (PINSEL_CFG_Type dummy)
{
	//Para tu mayor saber, son TODOS los pines de ethernet
	PIN_Init(ENET_TxD0__1_0);
	PIN_Init(ENET_TxD1__1_1);
	PIN_Init(ENET_TxD_EN__1_4);
	PIN_Init(ENET_CRS__1_8);
	PIN_Init(ENET_RxD0__1_9);
	PIN_Init(ENET_RxD1__1_10);
	PIN_Init(ENET_Rx_ER__1_14);
	PIN_Init(ENET_REF_CLK__1_15);
	PIN_Init(ENET_MDC__1_16);
	PIN_Init(ENET_MDIO__1_17);
}
