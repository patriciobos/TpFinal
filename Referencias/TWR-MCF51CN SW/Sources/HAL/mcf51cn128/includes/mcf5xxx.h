...
/*FSL:new one for CPUCR register!!!*/
void __declspec(register_abi) mcf5xxx_wr_cpucr (uint32);
/*FSL: byte reversing assembler line*/
uint32 __declspec(register_abi) mcf5xxx_byterev(uint32);
/*FSL: requests a reset command*/
void  __declspec(register_abi) mcf5xxx_reset (void);

int 	__declspec(register_abi) asm_set_ipl (uint32);
void	__declspec(register_abi) mcf5xxx_wr_cacr (uint32);
void	__declspec(register_abi) mcf5xxx_wr_acr0 (uint32);
void	__declspec(register_abi) mcf5xxx_wr_acr1 (uint32);
void	__declspec(register_abi) mcf5xxx_wr_acr2 (uint32);
void	__declspec(register_abi) mcf5xxx_wr_acr3 (uint32);
void	__declspec(register_abi) mcf5xxx_wr_other_a7 (uint32);
void	__declspec(register_abi) mcf5xxx_wr_other_sp (uint32);
void	__declspec(register_abi) mcf5xxx_wr_vbr (uint32);
void	__declspec(register_abi) mcf5xxx_wr_macsr (uint32);
void	__declspec(register_abi) mcf5xxx_wr_mask (uint32);
void	__declspec(register_abi) mcf5xxx_wr_acc0 (uint32);
void	__declspec(register_abi) mcf5xxx_wr_accext01 (uint32);
void	__declspec(register_abi) mcf5xxx_wr_accext23 (uint32);
void	__declspec(register_abi) mcf5xxx_wr_acc1 (uint32);
void	__declspec(register_abi) mcf5xxx_wr_acc2 (uint32);
void	__declspec(register_abi) mcf5xxx_wr_acc3 (uint32);
void	__declspec(register_abi) mcf5xxx_wr_sr (uint32);
void	__declspec(register_abi) mcf5xxx_wr_rambar0 (uint32);
void	__declspec(register_abi) mcf5xxx_wr_rambar1 (uint32);
void	__declspec(register_abi) mcf5xxx_wr_mbar (uint32);
void	__declspec(register_abi) mcf5xxx_wr_mbar0 (uint32);
void	__declspec(register_abi) mcf5xxx_wr_mbar1 (uint32);
